...
proc cluster_allocate_slots {masters} {
    set slot 16383
    while {$slot >= 0} {
...
proc start_cluster {masters replicas options code {slot_allocator continuous_slot_allocation} {replica_allocator default_replica_allocation}} {
    ...
    set cluster_options [list overrides [list cluster-enabled yes cluster-ping-interval 100 cluster-node-timeout $node_timeout]]
